...
import sbnz.integracija.example.security.authentication.RestAuthenticationEntryPoint;
import sbnz.integracija.example.security.authentication.TokenAuthenticationFilter;
import sbnz.integracija.example.service.CustomUserDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .authorizeRequests()
				.antMatchers("/**").permitAll() // TODO: ispraviti
