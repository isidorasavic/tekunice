...
import sbnz.integracija.example.security.authentication.JwtAuthenticationRequest;
...
//    private UserService userService;
	...
	public ResponseEntity<UserTokenState> createAuthenticationToken(@RequestBody JwtAuthenticationRequest authenticationRequest,
		...
		UserTokenState userTokenState = new UserTokenState(jwt, expiresIn, user.getUsername());
